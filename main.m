files_Brodatz = dir('D:\Kuliah\Semester 7\4. Visi Komputer\Tugas\FP\dtcwt-glcm\trunk\Brodatz\Training\dtcwt\*.png');

fitur_training_Brodatz = [];

for i = 1 : length(files_Brodatz)
    filename_Brodatz = strcat('D:\Kuliah\Semester 7\4. Visi Komputer\Tugas\FP\dtcwt-glcm\trunk\Brodatz\Training\dtcwt\', files_Brodatz(i).name);
...
files_VisTex = dir('D:\Kuliah\Semester 7\4. Visi Komputer\Tugas\FP\dtcwt-glcm\trunk\VisTex\Training\dtcwt\*.png');

fitur_training_VisTex = [];

for j = 1 : length(files_VisTex)
    filename_VisTex = strcat('D:\Kuliah\Semester 7\4. Visi Komputer\Tugas\FP\dtcwt-glcm\trunk\VisTex\Training\dtcwt\', files_VisTex(i).name);
